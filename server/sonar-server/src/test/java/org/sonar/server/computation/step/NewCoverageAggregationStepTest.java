...
public class NewCoverageAggregationStepTest {
  ...
  private static final org.sonar.server.computation.component.DumbComponent MOST_SIMPLE_ONE_FILE_TREE = builder(PROJECT, 1)
    .addChildren(
      builder(MODULE, 2)
        .addChildren(
          builder(DIRECTORY, 3)
  ...
  private static final org.sonar.server.computation.component.DumbComponent MANY_FILES_TREE = builder(PROJECT, 1)
    .addChildren(
      builder(MODULE, 11)
        .addChildren(
